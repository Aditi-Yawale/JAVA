//update matrix - if elements are odd then add one and make it even
...
class Matrix
{
    ...
    protected void finalized()   //OBJECT METHOD CHYA CLASS PASNA YETA THERFORRE PROTECTED IS CUMPOLSORY
    {
