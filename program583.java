//update matrix - matrix chya pratyek elements chya digits chi addition karaychi ani tyach elements chya jage vr update karaychi
//  DIAGONAL SUM FINALLY CORRECTED
import java.util.*;
...
class program583
{
    public static void main(String Arg[])
    {
        ...
        System.out.println("Sum of elements of diagonal is : "+iRet);

        mobj.SumEvenOdd();

        mobj.AdditionDigits();
        System.out.println("Matrix after updation of odd elements : ");
        mobj.Display();
...
class Matrix
{
    ...
    //called when garbage collector collects memory
    protected void finalize()   //OBJECT METHOD CHYA CLASS PASNA YETA THERFORRE PROTECTED IS CUMPOLSORY
    {
    ...
    public void RowSum()
    {
        ...
        for(i= 0; i < iRow; i++)
        {
            ...
            System.out.println("Summation of all elements of row no : "+i+" is "+iSum);
